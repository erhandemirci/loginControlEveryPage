...
class UtilityService: NSObject {
    ...
    static func appVersion() -> String {
        guard let av = Bundle.main.infoDictionary?["CFBundleShortVersionString"] as? String else {
            return ""
        }
    ...
    static func carrier() -> String {
        ...
        if let carrier = networkInfo.subscriberCellularProvider {
            guard let name = carrier.carrierName else {
                return ""
            }
    ...
    static func deviceToken() -> String {
        ...
        guard let token = LocalStorageService.value(forKey: .deviceToken) as? String else {
            return ""
        }
